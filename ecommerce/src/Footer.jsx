    ...
    <footer className="bg-green-100 text-black p-4"> {/* Adjusted padding here */}
      <div className="container mx-auto px-4 flex flex-wrap justify-between items-start">
        ...
        <div className="w-full md:w-1/5 mb-4">
          ...
          <ul>
            <li><a href="#" className="hover:underline">{t('About NestFix')}</a></li>
            ...
            <li><a href="#" className="hover:underline">{t('Contact Us')}</a></li>
          </ul>
        </div>

        {/* Payment Section */}
        <div className="w-full md:w-1/5 mb-4">
          <h3 className="text-lg font-bold mb-2 text-center">{t('Payment')}</h3>
          ...
          <div className="construction-retailer text-center">
            <h3 className="text-lg font-bold mb-2">{t('Construction Retailer')}</h3>
            <img 
        ...
        {/* Follow Us Section */}
        <div className="w-full md:w-1/5 mb-4">
          <h3 className="text-lg font-bold mb-2">{t('Follow Us')}</h3>
        ...
        <div className="w-full md:w-1/5 mb-4">
          ...
          <p>{t('Your go-to solution for reliable home services')}</p>
        </div>
      </div>
    </footer>
  );
